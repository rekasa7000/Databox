...
namespace Databox.Controls
{
    public class MenuRenderer : ToolStripProfessionalRenderer
    {
        ...
        public MenuRenderer(bool isMainMenu, Color primaryColor, Color menuItemTextColor) : base(new MenuColorTable(isMainMenu, primaryColor))
        {
            ...
            if (isMainMenu)
            {
                ...
                if (textColor == Color.Empty)//Set Default Color  
                    ...
                    this.textColor = Color.FromArgb(154, 192, 205);
            }
            else
            {
                arrowThickness = 2;
