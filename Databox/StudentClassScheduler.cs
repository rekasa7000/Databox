...
namespace Databox
{
    class StudentClassScheduler
    {
        ...
        public StudentClassScheduler(Form form)
        {
            activeForm = form;
        }
        ...
        void getEmail()
        {
            ...
            {
                cmd.Parameters.AddWithValue("@student_id", sessionData.StudentId);
        ...
        private void FetchSchedules()
        {
            ...
            string query = "SELECT schedule.schedule_id, CONCAT(class.className,' - ', class.classSection) AS classSelected, schedule.schedName, schedule.frequency, schedule.startTime, schedule.endTime, schedule.dayOfWeek, schedule.dayOfMonth, schedule.monthOfYear, schedule.scheduleDate " +
                ...
                "JOIN student_class ON student_class.class_id = class.class_id " +
        ...
        {
            string rem = $"You have class right now at {classSelected}";
