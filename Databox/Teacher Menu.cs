...
namespace Databox
{
    public partial class TeacherDashboard : Form
    {
        ...
        int thisTeacherID;
        public TeacherDashboard(int teacher_id)
        {
            thisTeacherID = teacher_id;
            InitializeComponent();
        ...
        {
            subMenuclass.Visible = false;
            subMenusched.Visible = false;
        ...
        private void ActivateButton(object senderBtn, Color color)
        {
            if (senderBtn != null)
            {
                DisableButton(); if (senderBtn is IconButton iconButton)
                {
                    currentBtn = (IconButton)senderBtn;
                    currentBtn.BackColor = Color.FromArgb(49, 51, 56);
        ...
        private void iconSchedule_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, Colors.PastelGreen);
            lblHome.Text = iconSchedule.Text;
            showSubMenu(subMenusched);
        }

        private void iconReport_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, Colors.PastelPink);
            lblHome.Text = iconReport.Text;
            OpenChildForm(new StudentProgressList(thisTeacherID, desktopPanel));
            hideSubMenu();
        }

        private void iconAccount_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, Colors.PastelPurple);
            lblHome.Text = iconAccount.Text;
            showSubMenu(subMenuAccount);
        }

        private void btnClassview_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Classes(thisTeacherID, desktopPanel));
        }

        private void btnClassarchive_Click(object sender, EventArgs e)
        {
            OpenChildForm(new ClassArchive(thisTeacherID, desktopPanel));
        }

        private void btnSchedview_Click(object sender, EventArgs e)
        {
            OpenChildForm(new ScheduleView(thisTeacherID, desktopPanel));
        }

        private void btnSchedcreate_Click(object sender, EventArgs e)
        {
            OpenChildForm(new ScheduleAdd(thisTeacherID, desktopPanel));
        }

        private void btnSchedarchive_Click(object sender, EventArgs e)
        {
            OpenChildForm(new ScheduleArchive(thisTeacherID, desktopPanel));
        }
